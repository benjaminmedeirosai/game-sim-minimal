...
function actionsPrompt(): string {
  return [
    ...
    '    target on their own, so do NOT emit a separate "move" before them. To chop',
    '    a tree at AB16, send just {"type":"harvest","unitId":"unit-1","target":"AB16"}',
    '    — not a move to AB16 followed by a harvest. Use "move" ONLY to reposition or',
    '    scout to a tile you take no other action on.',
